                ...
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mx-auto mb-0">
                            DisTreebution was initiated at the Swiss Data Science Center (SDSC) at EPFL to build practical, open tools for rigorous uncertainty quantification and distributional prediction. The project aims to deliver tree-based scalable algorithms, reproducible workflows and clear evaluation metrics so practitioners can deploy models that communicate uncertainty reliably.
                        </p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
