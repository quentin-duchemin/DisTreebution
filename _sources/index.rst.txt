.. DisTreebution documentation master file, created by
...
Documentation
~~~~~~~~~~~~~
`DisTreebution` is a package for learning random forests for distributional regression. The package is developed and maintained by the `Swiss Data Science Center <https://www.datascience.ch/>`_.



If you use `DisTreebution` in your work, please cite our publication.
...
.. raw:: html
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex">
                ...
                <div class="card-body flex-fill">
                    ...
                    <p class="card-text">New to <em>DisTreebution</em>? Check out the installation guide.
                    </p>
...
.. container:: custom-button
    ...
    :doc:`To the documentation<documentation/DisTreebution>`
